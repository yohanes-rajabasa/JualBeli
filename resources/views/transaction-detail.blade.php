    ...
    <div class="mb-3">
        <div class="row">
            ...
            <div class="col d-flex flex-wrap align-content-end justify-content-center">
                <div class="title">
                    <h4>Item Price: ${{($detail->product->price * $detail->qty)}}</h4>
                </div>
...
<div class="container-fluid">
    <div class="d-flex justify-content-between">
        ...
        <div>
            <h6>$ <strong class="m-0 total">{{ $total }}</strong></h6>
        </div>
    </div>
    <div class="d-flex justify-content-between">
        <div>
        ...
        <div>
            <h6>$ <strong class="ppn">{{ ($total*15/100) }}</strong></h6>
        </div>
    </div>
</div>
<hr>
<div class="container-fluid">
    <div class="d-flex justify-content-between">
        ...
        <div>
            <h5>$ <strong class="grandPrice">{{($total+($total*15/100))}}</strong></h5>
        </div>
    </div>
</div>
@endsection
